...
@section('content')
    @include('admin.partials.header', ['title' => __('Add SubCategory')])
                        ...
                        <form method="post" action="{{ route('subCategory.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="category_id" id="input-name" class="form-control form-control-alternative{{ $errors->has('category_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Category') }}" value="{{ old('category') }}" required autofocus>
                                        @if($categories)
